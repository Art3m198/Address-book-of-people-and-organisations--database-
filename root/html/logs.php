...
?>
			...
			<!-- CONTENT -->
						<?php
$dbc = mysqli_connect('localhost', 'lustration', 'Fox174125', 'lustration') or die('Error connecting to MySQL server.'); 
if(isset($_POST['submit_button']))
{
    mysqli_query($dbc, 'TRUNCATE TABLE `logs`');
...
<form method="post" action="">
    <input name="submit_button" type="submit" value=" Clear log " />
</form>
