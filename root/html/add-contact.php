<?php
	...
	if(isset($_POST["submit"]) && $_POST["submit"] == "submit") {
		...
		if(empty($errors)) {
			...
			!empty($_POST['photo']) 					? $fields['photo'] = "../../uploads/persons/" . translit($_POST['last_name'] . "_". $_POST['first_name']) . "_" . preg_replace($pattern, $replacement, $_POST['added']) . "/" . $_POST['photo'] 																: $fields['photo'] = null;
...
?>
			...
			<form class="form-horizontal" action="" enctype="multipart/form-data" method="post" >
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" id = "1" class="form-control" name="last_name" placeholder="Last name" maxlength="50" <?php if(isset($_POST["last_name"])){ echo "value=\"" . htmlentities($_POST["last_name"]) . "\""; }; ?> required>
					</div></div><hr>
										<div class="form-group">
					<label class="col-sm-2 control-label">First name</label>
					<div class="col-sm-4">
						<input type="text" id = "2" class="form-control" name="first_name" placeholder="First name" maxlength="50" <?php if(isset($_POST["first_name"])){ echo "value=\"" . htmlentities($_POST["first_name"]) . "\""; }; ?> required>
					</div>
				</div><hr>
					...
					<div class="col-sm-4">
						<input type="text" id = "3" class="form-control" name="middle_name" placeholder="Middle name" maxlength="50" <?php if(isset($_POST["middle_name"])){ echo "value=\"" . htmlentities($_POST["middle_name"]) . "\""; }; ?>>
					</div></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4"> 					
						<label class="fa fa-male radio-inline"><input type="radio" name="gender" value="Male" required <?php if(isset($_POST["gender"])){ echo "value=\"" . htmlentities($_POST["gender"]) . "\""; }; ?>> Male</label>
						<label class="fa fa-female radio-inline"><input type="radio" name="gender" value="Female" <?php if(isset($_POST["gender"])){ echo "value=\"" . htmlentities($_POST["gender"]) . "\""; }; ?>> Female</label> 
					</div>
					
					<label class="col-sm-2 control-label">City</label>
					<div class="col-sm-4">
						<input type="text" id = "4" class="form-control" name="city" placeholder="City" maxlength="20" <?php if(isset($_POST["city"])){ echo "value=\"" . htmlentities($_POST["city"]) . "\""; }; ?>required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="date" class="form-control" name="date_of_birth" placeholder="Birthday" <?php if(isset($_POST["date_of_birth"])){ echo "value=\"" . htmlentities($_POST["date_of_birth"]) . "\""; }; ?>>
					</div>
					
					<label class="col-sm-2 control-label">Position</label>
					<div class="col-sm-4">
						<input type="text" id = "5" class="form-control" name="job" placeholder="Position" maxlength="100" <?php if(isset($_POST["job"])){ echo "value=\"" . htmlentities($_POST["job"]) . "\""; }; ?>required>
					</div>
				...
				<hr>
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" name="web" placeholder="Соц.сети (через запятую)" maxlength="1000" <?php if(isset($_POST["web"])){ echo "value=\"" . htmlentities($_POST["web"]) . "\""; }; ?>>
					</div></div><hr>		
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" name="added" readonly value="<?php echo date("d.m.Y");?>" <?php if(isset($_POST["added"])){ echo "value=\"" . htmlentities($_POST["added"]) . "\""; }; ?> required>
					</div>
				</div><hr>
									<div class="form-group">
