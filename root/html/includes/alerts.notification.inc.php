<?php
	...
	$notification = array (
		...
		"contact" => array (
			...
			"add" => array (
				"success" => "New organisation added successfully",
				"failure" => "A organisation cannot be added",
			),
			
			// Updating existing contacts in the address book
			"update" => array (
				"success" => "Organisation updated successfully",
				"failure" => "The organisation can't be updated",
			...
			"delete" => array (
				...
				"failure" => "Error when deleting a organisation",
				"not_found" => "Organisation not found"
			),
