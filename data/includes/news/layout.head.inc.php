...
?>
        ...
        <link rel="stylesheet" href="assets/src/richtext.min.css">
        <script type="text/javascript" src="assets/src/jquery.richtext.js"></script>
		<script type="text/javascript" src="assets/src/qrcode.min.js"></script>
		<script type="text/javascript" src="assets/src/autosize.js"></script>
