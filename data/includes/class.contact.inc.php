		...
		public function find_id($id = null) {
			...
			if($id) {
				...
				if($result) {
					...
					$this->first_name = htmlentities($this->first_name($result['first_name']));
					$this->last_name = htmlentities($this->last_name($result['last_name']));
					$this->middle_name = htmlentities($this->middle_name($result['middle_name']));
